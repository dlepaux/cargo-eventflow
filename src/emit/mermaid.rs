//! Mermaid emitter.
//!
//! Renders [`crate::model::Graph`] as a `graph LR` Mermaid diagram
//! with publisher-grouped subgraphs, flow-direction ingress/egress
//! trapezoids, per-edge `classDef` styling (renderer-compat for
//! older Mermaid), and a stable `@generated by` banner including
//! format version.
//!
